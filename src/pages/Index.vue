<template>
  <q-layout view="lHh lpr lFf">
    <q-header class="q-py-sm" style="background-color: #1c1b21;" :style="'border-bottom: 2px solid '+ theme_color">
        <q-toolbar>
        <span :style="'font-size: 35px;color:'+theme_color" class="my-font text-h6 q-mr-md">DUDU SOLUTIONS</span>
        <q-space ></q-space>
	...
	<q-tab :style= "[selected_tab == 't_6' ? {backgroundColor: theme_color} : {}]" class="q-mr-sm q-py-xs custom_tab" @click="scrollToElement('id_news');" style="width:120px;min-height:auto !important;color: white" label="News" />
        <q-btn class="q-mr-md" size="12px" :style="'min-height:auto !important;background:'+ theme_color +'; color: white; padding:1px'" dense icon="color_lens">
          ...
          <a style="font-size: 25px;" class="float-right q-mr-sm" href="https://github.com/kiocjw"
...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
              <div class="text-h2 main_line animation_2">WELCOME TO <span :style="'color:'+theme_color">DUDU SOLUTIONS</span></div><br><br><br>
...
<div class="full-height full-width flex flex-center" style="background-color: rgba(0, 0, 0, 0.68) !important;">
            <div class="custom-caption">
    	      <div class="text-h2 main_line animation_2" style="font-size:65px;"><span :style="'color:'+theme_color">DUDU SOLUTIONS</span> FOR THE BEST</div><br><br><br>
...
<q-btn size="md" :style="'background:'+ theme_color +'; color: white'" label="READ MORE"/>
          ...
          <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
            <q-card class="q-pa-sm flex flex-center text-center box-shadow" style="margin: 40px;">
              ...
              <q-card-section class="q-pt-none">
                DUDU SOLUTIONS READY PROVIDE CONSULTATION AND DEVELOPMENT SERVICE
              </q-card-section>
            </q-card>
          </div>
          <div class="col-md-3 col-lg-3 col-xs-12 col-sm-12">
        ...
        <div class="quote">
          <div class="q-pt-xl full-width full-height flex flex-center" style="background-color: #000000ad !important;">
            <h3 class="text-white text-center">DUDU SOLUTIONS FOR U
              <br>
              <br>
              <q-btn type="a" href="https://api.whatsapp.com/send/?phone=60165764520&text&app_absent=0" size="lg"
                     :style="'background:'+ theme_color +'; color: white'" label="Get In Touch With Us"/>
            </h3>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
              <h5 class="text-center">Our Portfolio
                <br>
                <span class="text-center text-grey text-h6">DUDU SOLUTIONS FOR EVERYONE</span>
              </h5>
            </div>
          </div>
          <br>
        ...
        <div class="row" id="id_about_us">
          <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">
            <h5 class="text-center">About Us
              <br>
              <span
                class="text-center text-grey text-h6">DUDU SOLUTIONS FIND SUITABLE SOLUTIONS FOR ALL</span>
            </h5>
          </div>
        </div>
            ...
            <div class="col-md-4 col-lg-4 col-sx-12 col-sm-12">
              <q-card @mouseover="hoverOver(3)" @mouseout="hoverOutTimeout(3)" style="border: none;" class="my-card text-center box-shadow" flat bordered>
                ...
                <q-card-section>
                  ...
                  <div class="text-caption text-grey-9">
                    LDUDU SOLUTIONS ALL ABOUT SOLUTIONS
                  </div>
                </q-card-section>
              </q-card>
            </div>
              ...
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <q-item class="box-shadow q-pa-none q-ml-xs ">
                  ...
                  <q-item-section class="q-pa-md q-ml-none">
                    ...
                    <q-item-label class="text-grey-8">DUDU SOLUTIONS FIND SUITABLE SOLUTIONS FOR ALL</q-item-label>
                  </q-item-section>
                </q-item>
              </div>
              <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
...
<q-carousel
    ...
    >
      <q-carousel-slide style="padding-bottom: 140px" name="style" class="column no-wrap flex-center">
        <img :style="'margin-top:100px;border-radius:5px;border: 4px solid ' + theme_color" src="/statics/images/team_1.png" width=150 height=150>
	<div class="q-mt-md text-h6 text-center">
	   <span :style="'color:'+theme_color">Kio Chai</span><br><span class="text-overline">Organization Founder</span>
	</div>
        <div class="q-mt-md text-h6 text-center">
          DUDU SOLUTIONS TEAM
        </div>
      ...
      <q-carousel-slide style="padding-bottom: 140px" name="tv" class="column no-wrap flex-center">
        <img :style="'margin-top:100px;border-radius:5px;border: 4px solid ' + theme_color" src="/statics/images/team_2.png" width=150 height=150>
	<div class="q-mt-md text-h6 text-center">
	   <span :style="'color:'+theme_color">Kio Chai</span><br><span class="text-overline">Lead Developer</span>
	</div>
        <div class="q-mt-md text-h6 text-center">
          DUDU SOLUTIONS TEAM
        </div>
      ...
      <q-carousel-slide style="padding-bottom: 140px" name="layers" class="column no-wrap flex-center">
        <img :style="'margin-top:100px;border-radius:5px;border: 4px solid ' + theme_color" src="/statics/images/team_3.png" width=150 height=150>
	<div class="q-mt-md text-h6 text-center">
	   <span :style="'color:'+theme_color">Kio Chai</span><br><span class="text-overline">Product Owner</span>
	</div>
        <div class="q-mt-md text-h6 text-center">
          DUDU SOLUTIONS TEAM
        </div>
                ...
                <div class="row fit justify-center items-center q-gutter-xs q-col-gutter no-wrap">
                  ...
                  <q-flashcard :no-hover="hover" :style="team_style">
                    <q-flashcard-section transition="['nudge-out', 'fade-out']" :active="active">
                      <img :src="'/statics/images/team_'+index+'.png'" width=260 height=263>
                    </q-flashcard-section>
                    <q-flashcard-section transition="fade-in" class="fit" :active="active">
                      <div class="fit" :style="background_style"></div>
            ...
            <q-card>
              ...
              <q-card-section class="q-pa-none" style="color: #ec982f">
                <div class="text-center">
                  <span class="text-h2 text-center">10,000</span>OR BELOW
                </div>
              </q-card-section>
              <q-card-section>
          ...
          <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
            <q-card>
              ...
              <q-card-section class="q-pa-none" style="color: #f4655f">
                <div class="text-center">
                  <span class="text-h2 text-center">20,000</span>OR BELOW
                </div>
              </q-card-section>
              <q-card-section>
                <div class="text-center q-px-lg">
          ...
          <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
            <q-card>
              ...
              <q-card-section class="q-pa-none" style="color: #8b3bbd">
                <div class="text-center">
                  <span class="text-h2 text-center">100,000</span>OR BELOW
                </div>
              </q-card-section>
              <q-card-section>
                <div class="text-center q-px-lg">
          ...
          <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6 q-px-lg">
            <q-card>
              ...
              <q-card-section class="q-pa-none" style="color: #3b97d1">
                <div class="text-center">
                  <span class="text-h2 text-center">100,000</span>OR ABOVE
                </div>
              </q-card-section>
              <q-card-section>
                <div class="text-center q-px-lg">
...
<q-btn size="lg" :style="'background:'+ theme_color +'; color: white'" label="Send Message"/>
	    ...
	    <q-btn round type="a" href="https://github.com/kiocjw"
